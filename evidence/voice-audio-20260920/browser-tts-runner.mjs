...
try{
 ...
 if(sabotage){
  ...
  fs.mkdirSync('evidence/voice-audio-20260920/browser-artifacts',{recursive:true});
  await page.screenshot({path:'evidence/voice-audio-20260920/browser-artifacts/chromium-reply-pipelining.png',fullPage:true});
